...
spark-submit --class "SparkNaiveBayesModelCreator" --master local[3] tweet-sentiment-analysis_2.11-0.1.jar
...
cd $FOLDER_NAME/target/scala-2.11/
spark-submit --class "TweetSentimentAnalyzer" --master local[3] tweet-sentiment-analysis_2.11-0.1.jar
